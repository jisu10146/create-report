...
모든 텍스트 필드(headline, description, items[].title/description/interpretation, StrategyTable cells, KeyFindings.text)를 §0-5 A~H 기준으로 대조한다.
...
- 추가: label과 description이 같은 정보를 반복하면 description은 새 정보로 다시 쓰기
